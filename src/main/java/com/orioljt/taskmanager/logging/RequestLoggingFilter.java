...
/**
 * Simple centralized request logging filter (safe fields only).
...
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            log.info("request_log timestamp={} method={} path={} status={} durationMs={} headers={}",
                    Instant.now().toString(), request.getMethod(), request.getRequestURI(), response.getStatus(), durationMs, safeHeaders);
        }
    }
}
