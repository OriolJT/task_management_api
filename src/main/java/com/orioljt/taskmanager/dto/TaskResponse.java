...
public record TaskResponse(
        ...
        @Schema(description = "Project id", example = "123e4567-e89b-12d3-a456-426614174000") UUID projectId,
        @Schema(description = "Creation timestamp", example = "2025-08-20T10:15:30Z") Instant createdAt
) {}
