...
public record ErrorResponse(
        @Schema(description = "Timestamp in ISO-8601", example = "2025-08-20T10:15:30.123Z") String timestamp,
        ...
        @Schema(description = "Field level validation errors: field -> messages") Map<String, List<String>> fieldErrors
) {
