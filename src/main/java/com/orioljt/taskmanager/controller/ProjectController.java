...
public class ProjectController {
    ...
    public ResponseEntity<List<ProjectResponse>> list(
        ...
        Pageable pageable = PageRequest.of(page, size, safeSort.isUnsorted() ? Sort.by(Sort.Direction.DESC, "createdAt") : safeSort);

        Page<ProjectResponse> result = projectService.page(pageable);
        var headers = PaginationUtil.generatePaginationHttpHeaders(uriBuilder.path("/api/projects"), result);
